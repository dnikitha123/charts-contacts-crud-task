...
const Contacts = () => {
  ...
  const [contacts, setContacts] = useState([
    { name: String, lastName: String, status: String },
  ]);
  ...
  return (
    <div id="contact_page">
      <Heading color={"white"} p={"10px 20px"} bg={"tomato"}>
        Contact Page
      </Heading>
      <div id="contact_page_div">
        ...
        >
          {flag ? (
            ...
            <Button marginTop={"20px"} onClick={onOpen} color={'black'} backgroundColor={'coral'} cursor={'pointer'}>
              Create Contact
            </Button>
          )}
          <Box>
            {flag ? (
              <form onSubmit={handleSubmit} id="form">
                ...
                <button onClick={onClose} cursor={'pointer'} display={'flex'}>Cancel</button>
                ...
                {data.map((el) => (
                  <div key={el.id}>
                    ...
                    <Popover>
                      ...
                      >
                        <PopoverCloseButton backgroundColor={"#bbc1c6"}>
                          <Button backgroundColor={"black"} color={"white"} cursor={'pointer'}>
                            cancel
                          </Button>
                        </PopoverCloseButton>
                    ...
                    <Popover>
                      <PopoverTrigger>
                        <button
                          style={{ color: "white", backgroundColor: "#194d33", cursor: 'pointer' }}
                        >
                          Edit
                        </button>
                      </PopoverTrigger>
                      ...
                      >
                        ...
                        <button onClick={(e) => handleSubmitEdit(e, el.id)} cursor={'pointer'}>
                          Submit
                        </button>
                      </PopoverContent>
                    </Popover>
